...
export function WithResponsiveVariants({ Component, variants, ...rest }) {
    ...
    // Only override variant from breakpoint lookup when it resolved to a value.
    // Otherwise rest.variant (passed directly by the user) wins.
    const finalProps = variant !== undefined ? { ...rest, variant } : rest;
