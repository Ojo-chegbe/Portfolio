      ...
      <div className="py-8 bg-zinc-950 border-t border-zinc-800">
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <Link 
              href="/#articles" 
              className="text-zinc-100 no-underline font-semibold px-8 py-4 rounded-none transition-all duration-300 bg-zinc-900 shadow-lg hover:-translate-y-1 hover:shadow-xl"
            >
              More Articles →
            </Link>
          </div>
